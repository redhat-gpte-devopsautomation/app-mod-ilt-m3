...
oc cp $(oc get pods --no-headers -o custom-columns=":metadata.name" -l name=codeserver):/home/codeserver/modern-app-dev/customers-tomcat-legacy/target/customers-tomcat-0.0.1-SNAPSHOT.war ${HOME}/customers-tomcat-0.0.1-SNAPSHOT.war
